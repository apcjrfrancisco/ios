                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <div class="card-body">
                                <p>Welcome to eTorrecamps!</p>

                                <p>These terms and conditions outline the rules and regulations for the use of Torrecamps
                                    Marketing's Website, located at www.etorrecamps.com.</p>

                                <p>By accessing this website we assume you accept these terms and conditions. Do not
                                    continue to use eTorrecamps if you do not agree to take all of the terms and conditions
                                ...
                                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and
                                    ...
                                    accordance with and subject to, prevailing law of ph. Any use of the above terminology
                                ...
                                <p>We employ the use of cookies. By accessing eTorrecamps, you agreed to use cookies in
                                    agreement with the Torrecamps Marketing's Privacy Policy. </p>
                                ...
                                <p>Unless otherwise stated, Torrecamps Marketing and/or its licensors own the intellectual
                                    property rights for all material on eTorrecamps. All intellectual property rights are
                                    reserved. You may access this from eTorrecamps for your own personal use subjected to
                                    restrictions set in these terms and conditions.</p>

                                <p>You must not:</p>
                                <ul>
                                    <li>Republish material from eTorrecamps</li>
                                    <li>Sell, rent or sub-license material from eTorrecamps</li>
                                    <li>Reproduce, duplicate or copy material from eTorrecamps</li>
                                    <li>Redistribute content from eTorrecamps</li>
                                </ul>

                                <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                                    information in certain areas of the website. Torrecamps Marketing does not filter, edit,
                                    publish or review Comments prior to their presence on the website. Comments do not
                                    reflect the views and opinions of Torrecamps Marketing,its agents and/or affiliates.
                                    Comments reflect the views and opinions of the person who post their views and opinions.
                                    To the extent permitted by applicable laws, Torrecamps Marketing shall not be liable for
                                ...
                                <p>Torrecamps Marketing reserves the right to monitor all Comments and to remove any
                                ...
                                <p>You hereby grant Torrecamps Marketing a non-exclusive license to use, reproduce, edit and
                                ...
                                <p>We will approve link requests from these organizations if we decide that: (a) the link
                                    ...
                                    visibility of the hyperlink compensates the absence of Torrecamps Marketing; and (d) the
                                ...
                                <p>If you are one of the organizations listed in paragraph 2 above and are interested in
                                    linking to our website, you must inform us by sending an e-mail to Torrecamps Marketing.
                                ...
                                <p>No use of Torrecamps Marketing's logo or other artwork will be allowed for linking absent
